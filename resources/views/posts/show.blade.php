   ...
   <div class="row">
        <div class="col-8">
            <div style="display: flex; padding: 15px; align-items: center; flex-direction: column; border: 1px solid #ccc; position: relative;">
                ...
                @if (isset($post->image))
                    <div style="width: 100%; background-image: url({{ $post->image->url() }}); min-height: 20rem; color: white; text-align:center; background-size: cover; background-repeat: no-repeat; padding: 10px; margin-bottom: 20px">
